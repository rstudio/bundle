...
- x:
  ...
  A [train](https://rdrr.io/pkg/caret/man/train.html) object returned
  from [`caret::train()`](https://rdrr.io/pkg/caret/man/train.html).
...
Primarily, these methods call
[`bundle()`](https://rstudio.github.io/bundle/reference/bundle.md) on
the output of `train_model_object$finalModel`. See the class of the
output of that slot for more details on the bundling method for that
object.
