...
- x:
  ...
  A [model_fit](https://parsnip.tidymodels.org/reference/model_fit.html)
...
See the class of the output of that function for more details on the
bundling method for that object.
