...
- x:
  ...
  A [recipe](https://recipes.tidymodels.org/reference/recipe.html)
  object returned from
  [recipes](https://recipes.tidymodels.org/reference/recipe.html).
...
every step in the
[recipe](https://recipes.tidymodels.org/reference/recipe.html) object.
See the classes of individual steps for more details on the bundling
