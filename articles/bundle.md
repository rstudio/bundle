...
[`bundle()`](https://rstudio.github.io/bundle/reference/bundle.md) and
...
called on a bundle object, the `situate()` element of the bundle will
re-load the `object` element and restore needed references in the new
environment. Thus, the output of
[`unbundle()`](https://rstudio.github.io/bundle/reference/bundle.md) is
ready to go for prediction wherever it is called.
