...
Thanks for using bundle! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/rstudio/bundle/issues/new).
...
requests](https://github.com/rstudio/bundle/issues) to make sure the bug
