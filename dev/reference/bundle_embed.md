...
- x:
  ...
  A [step_umap](https://embed.tidymodels.org/reference/step_umap.html)
  object returned from
  [embed](https://embed.tidymodels.org/reference/step_umap.html).
...
This method wraps
[`uwot::save_uwot()`](https://jlmelville.github.io/uwot/reference/save_uwot.html)
and
[`uwot::load_uwot()`](https://jlmelville.github.io/uwot/reference/load_uwot.html).
...
``` r
if (FALSE) { # rlang::is_installed(c("recipes", "embed", "irlba (>= 2.3.5.2)"))
