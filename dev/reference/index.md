...
- [`bundle(`*`<H2OAutoML>`*`)`](https://rstudio.github.io/bundle/dev/reference/bundle_h2o.md)
  [`bundle(`*`<H2OMultinomialModel>`*`)`](https://rstudio.github.io/bundle/dev/reference/bundle_h2o.md)
  [`bundle(`*`<H2OBinomialModel>`*`)`](https://rstudio.github.io/bundle/dev/reference/bundle_h2o.md)
  [`bundle(`*`<H2ORegressionModel>`*`)`](https://rstudio.github.io/bundle/dev/reference/bundle_h2o.md)
  :
