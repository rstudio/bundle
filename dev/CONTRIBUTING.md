...
This outlines how to propose a change to bundle. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("rstudio/bundle", fork = TRUE)`.
...
of Conduct](https://rstudio.github.io/bundle/dev/CODE_OF_CONDUCT.md). By
