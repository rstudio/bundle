...
Oof. This error is a bit much. It _does_ seem to point us to something helpful, though: it tells at that the lightgbm package provides its own functions to save lightgbm objects. 
